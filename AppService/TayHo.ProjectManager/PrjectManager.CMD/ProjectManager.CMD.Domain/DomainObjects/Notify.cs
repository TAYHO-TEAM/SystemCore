...
namespace ProjectManager.CMD.Domain.DomainObjects
{
    public class Notify : DOBase
    {
                        ...
                        string BodyContent) : this()
        {
            ...
            _message = Message;
            _link = Link;
            _notifyTemplateId = NotifyTemplateId;
            _title = Title;
            _sub = Sub;
        ...
        public int? TemplateId { get => _notifyTemplateId; }
        ...
        public void SetNotifyTemplateId(int? NotifyTemplateId) { _notifyTemplateId = !NotifyTemplateId.HasValue ? _notifyTemplateId : NotifyTemplateId; if (!IsValid()) throw new DomainException(_errorMessages); }
