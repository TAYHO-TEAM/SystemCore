...
namespace ProjectManager.CMD.Domain.DomainObjects
{
    public class NS_NganSachDetail : DOBase
    {
        ...
        public NS_NganSachDetail(int? NganSachId,
string CongViec,
decimal? GiaTri,
...
bool? isLock) : this()
        ...
        #region Properties
        public int? NganSachId { get => _nganSachId; }
        ...
        { _congViec = string.IsNullOrEmpty(CongViec) ? _congViec : CongViec; if (!IsValid()) throw new DomainException(_errorMessages); }
