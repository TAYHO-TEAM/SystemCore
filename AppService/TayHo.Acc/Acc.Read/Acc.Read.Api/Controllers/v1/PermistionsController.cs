...
namespace Acc.Read.Api.Controllers.v1
{
    ...
    public class PermistionsController : APIControllerBase
    {
        ...
        public PermistionsController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IDOBaseRepository<PermistionsDTO> dOBaseRepository) : base(mapper,httpContextAccessor)
        {
