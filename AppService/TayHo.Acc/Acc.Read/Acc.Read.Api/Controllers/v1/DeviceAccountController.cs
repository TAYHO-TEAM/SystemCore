...
namespace Acc.Read.Api.Controllers.v1
{
    ...
    public class DeviceAccountController : APIControllerBase
    {
        ...
        public DeviceAccountController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IDOBaseRepository<DeviceAccountDTO> dOBaseRepository) : base(mapper,httpContextAccessor)
        {
