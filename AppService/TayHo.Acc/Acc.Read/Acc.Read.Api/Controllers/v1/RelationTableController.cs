...
namespace Acc.Read.Api.Controllers.v1
{
    ...
    public class RelationTableController : APIControllerBase
    {
        ...
        public RelationTableController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IDOBaseRepository<RelationTableDTO> dOBaseRepository) : base(mapper,httpContextAccessor)
        {
